...
const DIAGRAMS = {
  ui: (
    <svg viewBox="0 0 560 300" xmlns="http://www.w3.org/2000/svg" style={{width:"100%",maxWidth:"560px"}}>
      <rect width="560" height="300" rx="8" fill="#0d1410"/>
      <rect x="8" y="8" width="544" height="46" rx="4" fill="#15291c" stroke="#22c55e" strokeWidth="1.5"/>
      ...
      <text x="52" y="24" fill="#6ee7a0" fontSize="8" fontWeight="600">ARCHITECTURE</text>
      <rect x="130" y="12" width="92" height="18" rx="3" fill="#22c55e" opacity="0.4"/>
      <text x="134" y="24" fill="#a7f3c8" fontSize="8" fontWeight="700">MASSING &amp; SITE ★</text>
      <text x="232" y="24" fill="#3a4a40" fontSize="8">ANNOTATE</text>
      <text x="292" y="24" fill="#3a4a40" fontSize="8">VIEW</text>
      <rect x="48" y="32" width="490" height="18" rx="2" fill="#0c1a11"/>
      <text x="55" y="44" fill="#6ee7a0" fontSize="7">🧱 Wall</text>
      <text x="105" y="44" fill="#6ee7a0" fontSize="7">⬛ Floor</text>
      <text x="155" y="44" fill="#6ee7a0" fontSize="7">🌍 Toposurface</text>
      <text x="235" y="44" fill="#6ee7a0" fontSize="7">🪜 Stair</text>
      <text x="285" y="44" fill="#6ee7a0" fontSize="7">🔧 Railing</text>
      <rect x="8" y="3" width="55" height="11" rx="3" fill="#22c55e"/>
      <text x="12" y="11" fill="#04140a" fontSize="7" fontWeight="700">① RIBBON</text>
      <rect x="8" y="60" width="125" height="110" rx="4" fill="#10180f" stroke="#9b4ff7" strokeWidth="1.5"/>
      <text x="14" y="74" fill="#c084fc" fontSize="8" fontWeight="700">Properties</text>
      <rect x="14" y="80" width="113" height="13" rx="2" fill="#161420"/>
      <text x="18" y="89" fill="#777" fontSize="6">Paving_Granite_60mm</text>
      <text x="14" y="104" fill="#555" fontSize="6">Height Offset From Level</text>
      <rect x="14" y="107" width="113" height="11" rx="2" fill="#161420"/>
      <text x="18" y="115" fill="#888" fontSize="6">0.0</text>
      ...
      <rect x="8" y="178" width="125" height="114" rx="4" fill="#10180f" stroke="#3d7ef5" strokeWidth="1.5"/>
      <text x="14" y="192" fill="#7ab3ff" fontSize="8" fontWeight="700">Project Browser</text>
      <text x="14" y="206" fill="#555" fontSize="6">▼ Floor Plans</text>
      <text x="22" y="217" fill="#888" fontSize="6">General Arrangement</text>
      <text x="22" y="227" fill="#888" fontSize="6">Grading and Levels</text>
      <text x="22" y="237" fill="#888" fontSize="6">Hard Landscape</text>
      <text x="22" y="247" fill="#888" fontSize="6">Soft Landscape</text>
      <text x="14" y="260" fill="#555" fontSize="6">▼ 3D Views</text>
      <text x="22" y="271" fill="#888" fontSize="6">Site View · Hardscape</text>
      ...
      <rect x="141" y="60" width="411" height="232" rx="4" fill="#0a100c" stroke="#1a2a20" strokeWidth="1"/>
      ...
      <text x="280" y="100" fill="#2a4a36" fontSize="10" textAnchor="middle">DRAWING AREA — SITE</text>
  ...
  floor: (
    <svg viewBox="0 0 560 240" xmlns="http://www.w3.org/2000/svg" style={{width:"100%",maxWidth:"560px"}}>
      <rect width="560" height="240" rx="8" fill="#0d1410"/>
      <text x="18" y="26" fill="#d8e8dc" fontSize="13" fontWeight="700">Floor — the base of paving</text>
      <rect x="15" y="40" width="165" height="150" rx="4" fill="#0a100c" stroke="#1a2a20"/>
      <text x="22" y="54" fill="#555" fontSize="7">① Closed Sketch Boundary</text>
      <rect x="35" y="65" width="125" height="100" rx="1" fill="none" stroke="#f59e0b" strokeWidth="2" strokeDasharray="6,3"/>
      <rect x="195" y="40" width="165" height="150" rx="4" fill="#0a100c" stroke="#22c55e" strokeWidth="1.5"/>
      ...
      <rect x="375" y="40" width="170" height="150" rx="4" fill="#0a100c" stroke="#1a2a20"/>
      <text x="382" y="54" fill="#555" fontSize="7">③ Edit Structure — layers</text>
      ...
      <text x="395" y="160" fill="#555" fontSize="6">Each layer: material + thickness</text>
      <text x="18" y="218" fill="#3a4a40" fontSize="8">Soil and grass = same process, different materials and hatches. The floor is the Swiss army knife of Landscape.</text>
    </svg>
  ),
  paving: (
    <svg viewBox="0 0 560 260" xmlns="http://www.w3.org/2000/svg" style={{width:"100%",maxWidth:"560px"}}>
      <rect width="560" height="260" rx="8" fill="#0d1410"/>
      <text x="18" y="26" fill="#d8e8dc" fontSize="13" fontWeight="700">Paving — full workflow</text>
      <defs><marker id="arP" markerWidth="6" markerHeight="6" refX="3" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="#3a4a40"/></marker></defs>
      <rect x="15" y="42" width="120" height="80" rx="6" fill="#10180f" stroke="#22c55e" strokeWidth="1.5"/>
      <text x="25" y="60" fill="#22c55e" fontSize="9" fontWeight="700">1. Duplicate</text>
      <text x="25" y="76" fill="#777" fontSize="7">Existing floor →</text>
      <text x="25" y="87" fill="#777" fontSize="7">Duplicate →</text>
      <text x="25" y="98" fill="#777" fontSize="7">rename:</text>
      <text x="25" y="110" fill="#6ee7a0" fontSize="6">Paving_Granite_60mm</text>
      <path d="M140 82 L155 82" stroke="#3a4a40" strokeWidth="2" markerEnd="url(#arP)"/>
      <rect x="160" y="42" width="120" height="80" rx="6" fill="#10180f" stroke="#22c55e" strokeWidth="1.5"/>
      <text x="170" y="60" fill="#22c55e" fontSize="9" fontWeight="700">2. Layers</text>
      <text x="170" y="76" fill="#777" fontSize="7">Edit Structure:</text>
      <text x="170" y="88" fill="#777" fontSize="7">finish + bedding</text>
      <text x="170" y="99" fill="#777" fontSize="7">+ sub-base, each</text>
      <text x="170" y="110" fill="#777" fontSize="7">with material</text>
      <path d="M285 82 L300 82" stroke="#3a4a40" strokeWidth="2" markerEnd="url(#arP)"/>
      <rect x="305" y="42" width="120" height="80" rx="6" fill="#10180f" stroke="#22c55e" strokeWidth="1.5"/>
      <text x="315" y="60" fill="#22c55e" fontSize="9" fontWeight="700">3. Patterns</text>
      <text x="315" y="76" fill="#777" fontSize="7">Material Editor:</text>
      <text x="315" y="88" fill="#777" fontSize="7">Surface pattern (2D)</text>
      <text x="315" y="99" fill="#777" fontSize="7">+ Cut pattern</text>
      <text x="315" y="110" fill="#777" fontSize="7">(section)</text>
      <path d="M430 82 L445 82" stroke="#3a4a40" strokeWidth="2" markerEnd="url(#arP)"/>
      <rect x="450" y="42" width="95" height="80" rx="6" fill="#10180f" stroke="#f59e0b" strokeWidth="1.5"/>
      <text x="460" y="60" fill="#f59e0b" fontSize="9" fontWeight="700">4. Grading</text>
      <text x="460" y="76" fill="#777" fontSize="7">Slopes with</text>
      <text x="460" y="88" fill="#777" fontSize="7">Modify Sub-</text>
      <text x="460" y="99" fill="#777" fontSize="7">elements</text>
      <text x="460" y="110" fill="#777" fontSize="7">(Grading lesson)</text>
      <rect x="15" y="140" width="530" height="100" rx="6" fill="#0a100c" stroke="#1a2a20"/>
      <text x="25" y="158" fill="#555" fontSize="8">Plan patterns — MODEL (real size, scales with view) vs DRAFTING (always readable)</text>
      <rect x="30" y="170" width="230" height="55" fill="#10180f" stroke="#2a3a30"/>
      ...
      <text x="95" y="237" fill="#3a4a40" fontSize="7">MODEL — real 600x600 slabs</text>
      <rect x="290" y="170" width="230" height="55" fill="#10180f" stroke="#2a3a30"/>
      <line x1="290" y1="178" x2="520" y2="178" stroke="#6ee7a0" strokeWidth="0.4" opacity="0.6"/>
      <line x1="290" y1="186" x2="520" y2="186" stroke="#6ee7a0" strokeWidth="0.4" opacity="0.6"/>
      <line x1="290" y1="194" x2="520" y2="194" stroke="#6ee7a0" strokeWidth="0.4" opacity="0.6"/>
      <line x1="290" y1="202" x2="520" y2="202" stroke="#6ee7a0" strokeWidth="0.4" opacity="0.6"/>
      <line x1="290" y1="210" x2="520" y2="210" stroke="#6ee7a0" strokeWidth="0.4" opacity="0.6"/>
      <line x1="290" y1="218" x2="520" y2="218" stroke="#6ee7a0" strokeWidth="0.4" opacity="0.6"/>
      <text x="355" y="237" fill="#3a4a40" fontSize="7">DRAFTING — fixed at any scale</text>
    </svg>
  ),
  grading: (
    <svg viewBox="0 0 560 280" xmlns="http://www.w3.org/2000/svg" style={{width:"100%",maxWidth:"560px"}}>
      <rect width="560" height="280" rx="8" fill="#0d1410"/>
      <text x="18" y="26" fill="#d8e8dc" fontSize="13" fontWeight="700">Grading — slopes on the floor</text>
      <rect x="15" y="42" width="255" height="130" rx="4" fill="#0a100c" stroke="#1a2a20"/>
      <text x="24" y="58" fill="#555" fontSize="8">PLAN — points and split lines</text>
      ...
      <rect x="290" y="42" width="255" height="130" rx="4" fill="#0a100c" stroke="#1a2a20"/>
      <text x="299" y="58" fill="#555" fontSize="8">SECTION — the valley created</text>
      ...
      <rect x="15" y="186" width="530" height="80" rx="6" fill="#0a100c" stroke="#1a2a20"/>
      <text x="25" y="204" fill="#f59e0b" fontSize="8" fontWeight="700">⚠️ Golden rules of Grading:</text>
      <text x="25" y="220" fill="#888" fontSize="8">1. Divide paving into regular modules — avoids the extreme Shape Editing warning</text>
      <text x="25" y="234" fill="#888" fontSize="8">2. In Edit Boundary do NOT delete segments on a shaped floor — elevations reset to 0</text>
      <text x="25" y="248" fill="#888" fontSize="8">3. Add Point doesn't snap to the model — sketch detail lines first as guides</text>
      <text x="25" y="262" fill="#888" fontSize="8">4. Negative numbers = downward. Reset Shape flattens everything</text>
    </svg>
  ),
  drainage: (
    <svg viewBox="0 0 560 270" xmlns="http://www.w3.org/2000/svg" style={{width:"100%",maxWidth:"560px"}}>
      <rect width="560" height="270" rx="8" fill="#0d1410"/>
      <text x="18" y="26" fill="#d8e8dc" fontSize="13" fontWeight="700">Drainage — sweep on a sloped path</text>
      <rect x="15" y="42" width="530" height="120" rx="4" fill="#0a100c" stroke="#1a2a20"/>
      <text x="24" y="58" fill="#555" fontSize="8">3D — the profile follows the sloped floor edge</text>
      ...
      <text x="330" y="148" fill="#6ee7a0" fontSize="7">→ the channel updates if the slope changes</text>
      <rect x="15" y="176" width="255" height="84" rx="6" fill="#10180f" stroke="#22c55e" strokeWidth="1"/>
      <text x="25" y="194" fill="#22c55e" fontSize="9" fontWeight="700">Way 1 — Floor-based family</text>
      <text x="25" y="210" fill="#888" fontSize="7">Point gratings and gullies. Applied to</text>
      <text x="25" y="222" fill="#888" fontSize="7">the floor they follow its slope.</text>
      ...
      <rect x="290" y="176" width="255" height="84" rx="6" fill="#10180f" stroke="#22c55e" strokeWidth="1"/>
      <text x="300" y="194" fill="#22c55e" fontSize="9" fontWeight="700">Way 2 — Model In-Place + Sweep</text>
      <text x="300" y="210" fill="#888" fontSize="7">Continuous channels. Category: Specialty</text>
      <text x="300" y="222" fill="#888" fontSize="7">Equipment or Plumbing Fixture (schedules).</text>
      <text x="300" y="238" fill="#888" fontSize="7">Sweep → Pick Path → floor edge in 3D</text>
      <text x="300" y="250" fill="#888" fontSize="7">→ sketched profile or Metric Profile.</text>
    </svg>
  ),
  topo: (
    <svg viewBox="0 0 560 270" xmlns="http://www.w3.org/2000/svg" style={{width:"100%",maxWidth:"560px"}}>
      <rect width="560" height="270" rx="8" fill="#0d1410"/>
      <text x="18" y="26" fill="#d8e8dc" fontSize="13" fontWeight="700">Toposurface — triangles, not contours</text>
      <rect x="15" y="42" width="255" height="140" rx="4" fill="#0a100c" stroke="#1a2a20"/>
      <text x="24" y="58" fill="#555" fontSize="8">Revit triangulates points (TIN)</text>
      ...
      <rect x="290" y="42" width="255" height="140" rx="4" fill="#0a100c" stroke="#1a2a20"/>
      <text x="299" y="58" fill="#555" fontSize="8">⭐ Best practice — TIN from Civil 3D</text>
      <defs><marker id="arT" markerWidth="6" markerHeight="6" refX="3" refY="3" orient="auto"><path d="M0,0 L6,3 L0,6 Z" fill="#3a4a40"/></marker></defs>
      <rect x="310" y="70" width="90" height="30" rx="4" fill="#15291c" stroke="#22c55e"/>
      <text x="318" y="89" fill="#6ee7a0" fontSize="8">Civil 3D — TIN</text>
      <path d="M400 85 L425 85" stroke="#3a4a40" strokeWidth="2" markerEnd="url(#arT)"/>
      <rect x="430" y="70" width="50" height="30" rx="4" fill="#15291c" stroke="#22c55e"/>
      <text x="442" y="89" fill="#6ee7a0" fontSize="8">DWG</text>
      <path d="M455 100 L455 120" stroke="#3a4a40" strokeWidth="2" markerEnd="url(#arT)"/>
      <rect x="380" y="125" width="150" height="30" rx="4" fill="#15291c" stroke="#22c55e" strokeWidth="1.5"/>
      <text x="388" y="144" fill="#a7f3c8" fontSize="8">Create from Import → vertices</text>
      <text x="299" y="172" fill="#555" fontSize="7">Far more accurate than contours</text>
      <rect x="15" y="196" width="530" height="64" rx="6" fill="#0a100c" stroke="#1a2a20"/>
      <text x="25" y="214" fill="#ef4444" fontSize="8" fontWeight="700">⚠️ Toposurface limits:</text>
      <text x="25" y="230" fill="#888" fontSize="8">One single infinite material · no layers · no voids · no water bodies</text>
      <text x="25" y="244" fill="#888" fontSize="8">Few hostable families · no interaction with paving · triangles only</text>
    </svg>
  ),
  cutfill: (
    <svg viewBox="0 0 560 250" xmlns="http://www.w3.org/2000/svg" style={{width:"100%",maxWidth:"560px"}}>
      <rect width="560" height="250" rx="8" fill="#0d1410"/>
      <text x="18" y="26" fill="#d8e8dc" fontSize="13" fontWeight="700">Net / Cut / Fill — Graded Region</text>
      <rect x="15" y="42" width="530" height="130" rx="4" fill="#0a100c" stroke="#1a2a20"/>
      <text x="24" y="58" fill="#555" fontSize="8">SECTION — existing surface vs design</text>
      <path d="M50 130 Q160 90 280 120 Q400 145 520 110" fill="none" stroke="#777" strokeWidth="2" strokeDasharray="6,3"/>
      <text x="55" y="120" fill="#777" fontSize="7">existing</text>
      ...
      <rect x="395" y="145" width="135" height="20" rx="3" fill="#15291c" stroke="#22c55e"/>
      <text x="403" y="158" fill="#a7f3c8" fontSize="7">Properties → Net/Cut/Fill m³</text>
      <rect x="15" y="186" width="530" height="50" rx="6" fill="#0a100c" stroke="#1a2a20"/>
      ...
      <text x="25" y="222" fill="#888" fontSize="8">The surface stays editable. Delete it and the terrain returns to its original form.</text>
    </svg>
  )
};
...
function renderText(text) {
  return text.split("\n").map((line, i) => {
    if (line === "---") return <hr key={i} style={{ border: "none", borderTop: "1px solid #1a2a20", margin: "10px 0" }} />;
...
export default function LandscapeTutor() {
  ...
  return (
    <div style={{ display: "flex", height: "100vh", background: "#0a0f0b", color: "#dde8e0", fontFamily: "'Inter', system-ui, sans-serif", overflow: "hidden", position: "relative" }}>

      {showWelcome && (
        <div style={{ position: "absolute", inset: 0, background: "rgba(4,8,5,0.93)", zIndex: 100, display: "flex", alignItems: "center", justifyContent: "center", padding: "20px", backdropFilter: "blur(4px)" }}>
          <div style={{ maxWidth: "480px", width: "100%", maxHeight: "90vh", overflowY: "auto", background: "#0e150f", border: "1px solid #1e3325", borderRadius: "16px", padding: "28px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "20px" }}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ fontSize: "12px", color: "#4a5a50" }}>{t.welcomeSubtitle}</div>
              </div>
              <div style={{ display: "flex", gap: "4px", flexShrink: 0 }}>
                {["it", "en"].map(l => (
                  <button key={l} onClick={() => { setLang(l); setMessages([]); }} style={{ padding: "5px 10px", borderRadius: "6px", border: `1px solid ${lang === l ? "#22c55e" : "#1e3325"}`, background: lang === l ? "rgba(34,197,94,0.12)" : "transparent", color: lang === l ? "#22c55e" : "#4a5a50", fontSize: "13px", cursor: "pointer", fontWeight: lang === l ? "700" : "400" }}>
                    {l === "it" ? "🇮🇹" : "🇬🇧"}
                  </button>
                ))}
              </div>
            </div>
            <div style={{ fontSize: "13px", color: "#8a9a90", lineHeight: "1.7", marginBottom: "20px" }}>{t.welcomeIntro}</div>
            {t.welcomeFeatures.map((item, i) => (
              <div key={i} style={{ display: "flex", gap: "12px", marginBottom: "12px", padding: "12px", background: "#0a0f0b", border: "1px solid #1e3325", borderRadius: "10px" }}>
                <div style={{ fontSize: "20px", flexShrink: 0 }}>{item.icon}</div>
                <div>
                  <div style={{ fontSize: "13px", fontWeight: "600", color: "#c8d8cc", marginBottom: "2px" }}>{item.title}</div>
                  <div style={{ fontSize: "12px", color: "#5a6a60", lineHeight: "1.6" }}>{item.desc}</div>
                </div>
              </div>
            ))}
            <div style={{ fontSize: "12px", color: "#5a6a60", lineHeight: "1.7", padding: "12px", background: "rgba(34,197,94,0.05)", border: "1px solid rgba(34,197,94,0.15)", borderRadius: "10px", marginBottom: "20px" }}>
              💡 <span style={{ color: "#6ee7a0", fontWeight: "600" }}>{t.welcomeTip}</span> {t.welcomeTipText}
            </div>
            <button onClick={() => setShowWelcome(false)} style={{ width: "100%", padding: "13px", borderRadius: "10px", border: "none", background: "linear-gradient(135deg, #22c55e, #0d9488)", color: "#04140a", fontWeight: "700", fontSize: "14px", cursor: "pointer" }}>
              {t.welcomeStart}
            </button>
          </div>
        </div>
      ...
      <div style={{ width: sidebarOpen ? "262px" : "0", minWidth: sidebarOpen ? "262px" : "0", background: "#0e150f", borderRight: "1px solid #16241a", display: "flex", flexDirection: "column", overflow: "hidden", transition: "all 0.25s ease", flexShrink: 0 }}>
        <div style={{ padding: "16px 14px", borderBottom: "1px solid #16241a", flexShrink: 0 }}>
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            ...
            <div>
              ...
              <div style={{ fontSize: "10px", color: "#3a4a40" }}>{t.appSubtitle}</div>
            </div>
          </div>
          <div style={{ marginTop: "12px" }}>
            <div style={{ display: "flex", justifyContent: "space-between", fontSize: "10px", color: "#3a4a40", marginBottom: "4px" }}>
              <span>{t.progress}</span><span style={{ color: "#22c55e" }}>{currentLesson}/{curriculum.length}</span>
            </div>
            <div style={{ height: "2px", background: "#16241a", borderRadius: "2px" }}>
          ...
          {curriculum.map((item, i) => {
            ...
            return (
              <React.Fragment key={item.id}>
                {showDivider && (
                  <div style={{ padding: "10px 12px 4px", fontSize: "9px", fontWeight: "700", letterSpacing: "1px", color: item.section === "landscape" ? "#22c55e" : "#3a4a40" }}>
                ...
                <button onClick={() => setCurrentLesson(i)} style={{ width: "100%", textAlign: "left", padding: "7px 10px", borderRadius: "6px", border: "none", cursor: "pointer", marginBottom: "1px", background: currentLesson === i ? "rgba(34,197,94,0.1)" : "transparent", borderLeft: `2px solid ${currentLesson === i ? "#22c55e" : "transparent"}` }}>
                  <div style={{ display: "flex", alignItems: "center", gap: "7px" }}>
                    <span style={{ fontSize: "9px", fontWeight: "700", color: i < currentLesson ? "#22c55e" : currentLesson === i ? "#22c55e" : "#22301f", minWidth: "16px" }}>
                      {i < currentLesson ? "✓" : String(item.id).padStart(2, "0")}
                    </span>
                    <span style={{ fontSize: "12px", color: currentLesson === i ? "#dde8e0" : i < currentLesson ? "#3a4a40" : "#6a7a70", fontWeight: currentLesson === i ? "600" : "400", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{item.title}</span>
                  </div>
                </button>
              </React.Fragment>
            );
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", minWidth: 0 }}>
        <div style={{ padding: "10px 16px", borderBottom: "1px solid #16241a", display: "flex", alignItems: "center", gap: "10px", background: "#0e150f", flexShrink: 0 }}>
          <button onClick={() => setSidebarOpen(o => !o)} style={{ background: "none", border: "none", color: "#2a3a30", cursor: "pointer", fontSize: "17px", padding: "2px", lineHeight: 1, flexShrink: 0 }}>☰</button>
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ fontSize: "10px", color: "#2a3a30" }}>{t.lessonOf(lesson.id, curriculum.length)}</div>
            <div style={{ fontSize: "14px", fontWeight: "700", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{lesson.title}</div>
          </div>
          <div style={{ display: "flex", gap: "3px", flexShrink: 0 }}>
            {["it","en"].map(l => (
              <button key={l} onClick={() => { setLang(l); setMessages([]); }} style={{ padding: "3px 7px", borderRadius: "5px", border: `1px solid ${lang === l ? "#22c55e" : "#16241a"}`, background: lang === l ? "rgba(34,197,94,0.1)" : "transparent", color: lang === l ? "#22c55e" : "#2a3a30", fontSize: "12px", cursor: "pointer" }}>
                {l === "it" ? "🇮🇹" : "🇬🇧"}
              </button>
            ))}
          </div>
        ...
        <div style={{ display: "flex", borderBottom: "1px solid #16241a", background: "#0e150f", flexShrink: 0 }}>
          {["chat", "steps"].map(tab => (
            <button key={tab} onClick={() => setActiveTab(tab)} style={{ padding: "8px 16px", border: "none", background: "transparent", color: activeTab === tab ? "#22c55e" : "#2a3a30", fontSize: "12px", fontWeight: activeTab === tab ? "600" : "400", cursor: "pointer", borderBottom: `2px solid ${activeTab === tab ? "#22c55e" : "transparent"}` }}>
        ...
        {activeTab === "steps" && (
          <div style={{ flex: 1, overflowY: "auto", padding: "16px" }}>
            <div style={{ marginBottom: "14px", padding: "12px", background: "#0e150f", border: "1px solid #16241a", borderRadius: "8px" }}>
              <div style={{ fontSize: "10px", color: "#2a3a30", marginBottom: "4px", textTransform: "uppercase", letterSpacing: "0.5px" }}>{t.objective}</div>
              <div style={{ fontSize: "13px", color: "#6a7a70", lineHeight: "1.6" }}>{lesson.objective}</div>
            </div>
            {lesson.diagram && DIAGRAMS[lesson.diagram] && (
              <div style={{ marginBottom: "14px", padding: "12px", background: "#080d09", border: "1px solid #16241a", borderRadius: "8px" }}>
                <div style={{ fontSize: "10px", color: "#2a3a30", marginBottom: "8px", textTransform: "uppercase", letterSpacing: "0.5px" }}>{t.diagram}</div>
                {DIAGRAMS[lesson.diagram]}
              </div>
            )}
            <div style={{ fontSize: "10px", color: "#2a3a30", marginBottom: "8px", textTransform: "uppercase", letterSpacing: "0.5px" }}>{t.steps}</div>
            {lesson.steps.map((step, i) => (
              <div key={i} style={{ display: "flex", gap: "12px", marginBottom: "8px", padding: "12px 14px", background: "#0e150f", border: "1px solid #16241a", borderRadius: "9px" }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ fontSize: "12px", fontWeight: "600", color: "#b8c8bc", marginBottom: "3px" }}>{step.label}</div>
                  <div style={{ fontSize: "12px", color: "#5a6a60", lineHeight: "1.6" }}>{step.desc}</div>
                  <button onClick={() => askAboutStep(step)} style={{ marginTop: "8px", padding: "3px 10px", borderRadius: "5px", border: "1px solid #16241a", background: "transparent", color: "#22c55e", fontSize: "11px", cursor: "pointer" }}>{t.askAI}</button>
                </div>
              </div>
            ))}
        ...
        {activeTab === "chat" && (
          <>
            <div style={{ flex: 1, overflowY: "auto", padding: "16px" }}>
              {messages.length === 0 && (
                <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "100%", gap: "14px", textAlign: "center" }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: "12px", color: "#3a4a40", maxWidth: "300px", lineHeight: "1.6" }}>{lesson.objective}</div>
                  </div>
                  <div style={{ display: "flex", gap: "8px" }}>
                    <button onClick={startLesson} style={{ padding: "9px 22px", borderRadius: "8px", border: "none", background: "linear-gradient(135deg, #22c55e, #0d9488)", color: "#04140a", fontWeight: "700", fontSize: "13px", cursor: "pointer" }}>{t.startLesson}</button>
                    <button onClick={() => setActiveTab("steps")} style={{ padding: "9px 16px", borderRadius: "8px", border: "1px solid #16241a", background: "transparent", color: "#4a5a50", fontSize: "13px", cursor: "pointer" }}>{t.viewGuide}</button>
                  </div>
                </div>
              )}
              {messages.map((msg, i) => (
                <div key={i} style={{ marginBottom: "14px", display: "flex", gap: "8px", flexDirection: msg.role === "user" ? "row-reverse" : "row" }}>
                  <div style={{ width: "26px", height: "26px", borderRadius: "6px", flexShrink: 0, background: msg.role === "user" ? "#16241a" : "linear-gradient(135deg, #22c55e, #0d9488)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "11px" }}>
                    {msg.role === "user" ? "👤" : "🌿"}
                  </div>
                  <div style={{ maxWidth: "82%", minWidth: 0 }}>
                    {msg.hasImage && <div style={{ marginBottom: "4px", fontSize: "10px", color: "#2a3a30" }}>{t.screenshotLabel}</div>}
                    <div style={{ padding: "11px 13px", borderRadius: msg.role === "user" ? "11px 2px 11px 11px" : "2px 11px 11px 11px", background: msg.role === "user" ? "#121d16" : "#0e150f", border: "1px solid #16241a", fontSize: "13px", color: "#a8b8ac" }}>
              ...
              {loading && (
                <div style={{ display: "flex", gap: "8px", marginBottom: "14px" }}>
                  ...
                  <div style={{ padding: "11px 13px", borderRadius: "2px 11px 11px 11px", background: "#0e150f", border: "1px solid #16241a", display: "flex", gap: "4px", alignItems: "center" }}>
            ...
            {imagePreview && (
              <div style={{ padding: "7px 16px 0", display: "flex", alignItems: "center", gap: "7px", background: "#0a0f0b" }}>
                <img src={imagePreview} style={{ height: "44px", borderRadius: "5px", border: "1px solid #16241a" }} alt="preview" />
                <button onClick={() => { setImageData(null); setImagePreview(null); }} style={{ background: "#16241a", border: "none", color: "#5a6a60", cursor: "pointer", borderRadius: "4px", padding: "2px 8px", fontSize: "11px" }}>✕</button>
              </div>
            )}
            <div style={{ padding: "10px 16px", borderTop: "1px solid #16241a", background: "#0e150f", flexShrink: 0 }}>
              <div style={{ display: "flex", gap: "7px", alignItems: "flex-end" }}>
                <button onClick={() => fileInputRef.current?.click()} style={{ padding: "7px", borderRadius: "7px", border: "1px solid #16241a", background: "#0a0f0b", color: "#2a3a30", cursor: "pointer", fontSize: "15px", flexShrink: 0, lineHeight: 1 }}>📎</button>
                ...
                <textarea value={input} onChange={e => setInput(e.target.value)} onKeyDown={handleKeyDown} placeholder={t.inputPlaceholder} rows={1}
                  style={{ flex: 1, padding: "8px 12px", borderRadius: "7px", border: "1px solid #16241a", background: "#0a0f0b", color: "#dde8e0", fontSize: "13px", resize: "none", outline: "none", fontFamily: "inherit", lineHeight: "1.5", maxHeight: "90px" }}
                ...
                <button onClick={sendMessage} disabled={loading || (!input.trim() && !imageData)}
                  style={{ padding: "8px 14px", borderRadius: "7px", border: "none", background: loading || (!input.trim() && !imageData) ? "#16241a" : "linear-gradient(135deg, #22c55e, #0d9488)", color: loading || (!input.trim() && !imageData) ? "#22301f" : "#04140a", cursor: loading || (!input.trim() && !imageData) ? "not-allowed" : "pointer", fontWeight: "700", fontSize: "12px", flexShrink: 0 }}>
                  {t.send}
                </button>
              </div>
              <div style={{ marginTop: "4px", fontSize: "10px", color: "#16241a", textAlign: "center" }}>{t.inputHint}</div>
            </div>
          </>
        )}
      </div>
      <style>{`
        ...
        ::-webkit-scrollbar{width:3px} ::-webkit-scrollbar-track{background:transparent} ::-webkit-scrollbar-thumb{background:#16241a;border-radius:2px}
